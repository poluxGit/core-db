...
-- Add Link type 'Sigle'
-- -----------------------------------------------------
CALL CORE_addAttributeDefinitionForAnObject('ECM_TYPEDOC','Sigle','Sigle du type de doc','Sigle du type de doc','TEXT','','Non defini');
-- TODO
-- -----------------------------------------------------
-- Add Link type 'Ordre'
-- -----------------------------------------------------
...
ORDER BY obj.tid;
-- -----------------------------------------------------------------------------
-- View definition header about complex Object named `V_TYPEDOC_ALL`
-- -----------------------------------------------------------------------------
CREATE OR REPLACE VIEW `ECM_V_TYPEDOC` AS
SELECT
  obj.tid,
  obj.bid,
  obj.stitle
  , aobj1.attr_value AS `Sigle` 
  ...
  obj.utime,
  obj.isActive
FROM `ECM_TYPEDOC` obj 
LEFT JOIN CORE_ATTROBJECTS aobj1 ON (aobj1.stitle = 'Sigle' AND aobj1.obj_tid = obj.tid) 
